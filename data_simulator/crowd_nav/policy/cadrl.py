...
class CADRL(Policy):
    ...
    def configure(self, config):
        ...
        print('Debug: cadrl.py line 64  ----> self.model=',self.model)
    ...
    def transform(self, state):
        ...
        #print('------------------------debug cadrl.py line 193---------------------------')

        #print('----------------------cadrl--transformation is called !!!!!---------------------------')
    ...
    def rotate(self, state):
        ...
        #print('------------------------debug cadrl.py line 208-- rotation-------------------------')

        #print('------------------------rotatation done !!!!!---------------------------')
