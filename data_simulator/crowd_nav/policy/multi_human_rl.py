...
class MultiHumanRL(CADRL):
    ...
    def transform(self, state):
        ...
        ## saleh: # shows everything about humans
        #print(state.human_state)
        #print('-----debug: multihuman_rl.py line 101 --------- transformation is called------------------------------------------------------------------')
        ###
        ...
        if self.with_om:
            ...
            #print('-----debug: multihuman_rl.py line 106 --------- rotatation is called------------------------------------------------------------------')
            state_tensor = torch.cat([self.rotate(state_tensor), occupancy_maps], dim=1)
        else:

            #print('-----debug: multihuman_rl.py line 109 --------- rotatation is called---------------------------------------------------------------------')
