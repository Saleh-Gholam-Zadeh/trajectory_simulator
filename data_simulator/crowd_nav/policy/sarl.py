...
class ValueNetwork(nn.Module):
    def __init__(self, input_dim, self_state_dim, mlp1_dims, mlp2_dims, mlp3_dims, attention_dims, with_global_state,
        ...
        ####    #####
        # print('------------------------------debug:ValueNetwork--------------------------------------------')
        # print('sarl.py line 31: input_dim,self_state_dim = ',input_dim,self_state_dim )
        #
        # print('----')
        # print('mlp1_dims,mlp2_dims,mlp3_dims,attention_dims',mlp1_dims,mlp2_dims,mlp3_dims,attention_dims)
        # print('-------------------------------End:debug---------------------------------------------')
        ####  ####
    ...
    def forward(self, state):
        ...
        value = self.mlp3(joint_state) #joint_state =[100*56]
        return value


class SARL(MultiHumanRL):
   # print('-------------Debug sarl.py line 86----------------------')
